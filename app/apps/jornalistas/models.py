...
class Jornalista(models.Model):
    ...
    show_nome_de_guerra = models.BooleanField()
    nome_de_guerra = models.CharField(max_length=50)
    show_nome = models.BooleanField()
    nome = models.CharField(max_length=255)
    show_sobrenome = models.BooleanField()
    sobrenome = models.CharField(max_length=255)
    show_associacoes = models.BooleanField()
    associacoes = models.ManyToManyField(Associacao, blank=True)
    show_cpf = models.BooleanField()
    cpf = models.CharField(max_length=11)
    show_data_de_nascimento = models.BooleanField()
    data_de_nascimento = models.DateField()
    show_ddi = models.BooleanField()
    ddi = models.CharField(max_length=4)
    show_telefone = models.BooleanField()
    telefone = models.CharField(max_length=11)
    show_genero = models.BooleanField()
    genero = models.ForeignKey(Genero, on_delete=models.PROTECT)
    show_estado_civil = models.BooleanField()
    estado_civil = models.ForeignKey(EstadoCivil, on_delete=models.PROTECT)
    show_foto = models.BooleanField()
    foto = models.ImageField(null=True, blank=True)
    show_registro = models.BooleanField()
