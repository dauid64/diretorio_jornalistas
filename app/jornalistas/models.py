...
class Jornalista(models.Model):
    ...
    revisor_responsavel = models.ForeignKey('revisores.Revisor', on_delete=models.DO_NOTHING, null=True)
    obras_jornalisticas = models.ManyToManyField(ObraJornalistica, blank=True)
    historico_profissional = models.ManyToManyField(HistoricoProfissional, blank=True)
